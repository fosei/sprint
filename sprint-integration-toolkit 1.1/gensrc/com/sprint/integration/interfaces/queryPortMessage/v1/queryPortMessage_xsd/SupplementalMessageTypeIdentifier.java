...
public class SupplementalMessageTypeIdentifier implements java.io.Serializable {
    ...
    public static final SupplementalMessageTypeIdentifier value3 = new SupplementalMessageTypeIdentifier(_value3);
    public static final SupplementalMessageTypeIdentifier value4 = new SupplementalMessageTypeIdentifier(_value4);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://integration.sprint.com/interfaces/queryPortMessage/v1/queryPortMessage.xsd", "SupplementalMessageTypeIdentifier"));
    }
    /**
